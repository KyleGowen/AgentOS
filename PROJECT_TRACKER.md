...
| 10 - Your Playbook | Your Playbook | `projects/10-playbook/` | Complete | 2026-08-17 | `PLAYBOOK.md` documents the operating system, its agents, skills, and recurring-task status; Kyle's reflection, a source-grounded final review, an on-demand map, and a manual monthly `os-map` cadence are recorded. | <https://aidbagentos.ai/projects> |
| 11 - Automations | Automations | `projects/11-automations/` | Complete | 2026-08-17 | Three harness-neutral automation policies are active: appointment acceptance and SDGE jobs run on schedule, wanted-card is intentionally paused; date-keyed run evidence plus a failure-path policy for wanted-card are added. | <https://aidbagentos.ai/projects> |
